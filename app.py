...
yearago = dt.datetime.strftime(yearago, '%Y-%m-%d')
...
@app.route("/")
def home():
    return (f"Welcome to Hawai'i Climate API<br/>"
            f"-------------------------------------<br/>"
            f"Available Routes:<br/>"
            f"/api/v1.0/stations ----- a list of weather stations<br/>"
            f"/api/v1.0/precipitaton ----- preceipitation data<br/>"
            f"/api/v1.0/temperature ----- temperature data<br/>"
            f"--------------------------------------<br/>"
            f"/api/v1.0/datesearch/2015-05-30  -----low, high, and average temp for Start date <br/>"
            f"/api/v1.0/datesearch/2015-05-30/2016-01-30 ----- low, high, and average temp for Start date and end date <br/>"
            f"------------------------------------------<br/>")
